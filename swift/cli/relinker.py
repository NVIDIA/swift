...
def relink(swift_dir='/etc/swift',
    ...
    for policy in POLICIES:
        ...
        if objects_per_second > 0:
            locations = RateLimitedIterator(locations, objects_per_second)
...
def main(args):
    ...
    parser.add_argument('--objects-per-second', default=None,
                        type=non_negative_float, dest='objects_per_second',
    ...
    objects_per_second = non_negative_float(
        args.objects_per_second or conf.get('objects_per_second', '0'))
