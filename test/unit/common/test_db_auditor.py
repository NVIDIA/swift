...
class TestAuditor(unittest.TestCase):
    ...
    def test_database_auditor_freelist_vacuum_configs(self):
        ...
        def do_test(config, expected_inc_stats, expected_gauge_stats):
            self.logger = debug_logger()
            with mock.patch('swift.common.db_auditor.audit_location_generator',
            ...
            self.assertEqual(
                ...
                test_auditor.logger.statsd_client.get_increment_counts())
            self.assertEqual(
                expected_gauge_stats,
                test_auditor.logger.statsd_client.get_latest_gauges())
        ...
        do_test(conf, expected_inc_stats, expected_gauge_stats)
