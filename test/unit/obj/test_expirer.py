...
class TestObjectExpirer(TestCase):
    ...
    def _do_test_task_queue_iteration_order(self, stub_shuffle):
        """
        ...
        self.conf['randomized_task_container_iteration'] = 'true'
    ...
    def test_container_timestamp_break(self):
        ...
        captured = {c[0] for c in mock_method.call_args_list}
