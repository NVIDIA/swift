...
class ObjectChecksumMixin(object):
    ...
    def test_mpu_complete_good_checksum(self):
        ...
        self.assertEqual(200, complete_mpu_resp[
            'ResponseMetadata']['HTTPStatusCode'])
        # TODO: AWS includes the checksum in the response, but Swift doesn't
...
class TestObjectChecksumCRC64NVME(ObjectChecksumMixin,
    ...
    @classmethod
    def setUpClass(cls):
        # reminder to add these tests in future
        raise SkipTest('Swift does not support crc64nvme')
...
class TestObjectChecksums(BaseS3TestCaseWithBucket):
    ...
    def test_mpu_has_no_checksum(self):
        ...
        # TODO: ...but none of that stops AWS from storing a checksum anyway
    ...
    def test_multipart_mpu(self):
        ...
        # TODO: AWS returns a CRC here, but Swift won't
